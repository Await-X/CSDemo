...
@implementation XShareUI

static XShareUI *sheet = nil;
...
- (instancetype)initWithTitles:(NSArray *)titles iconNames:(NSArray *)iconNames
{
    ...
    if (self) {
        ...
        for (int i = 0; i < count ; i++) {
            XShareItem *item = [[XShareItem alloc] initWithFrame:CGRectMake(itemX, 30, 60, 110)];
            item.btnIndex = i;
...
- (void)clickAction:(XShareItem *)item
{
    if (_clickBlock) {
