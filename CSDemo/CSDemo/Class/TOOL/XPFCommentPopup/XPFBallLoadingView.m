...
@implementation XPFBallLoadingView

+ (instancetype)loadingViewInView:(UIView *)view {
    XPFBallLoadingView *loadingView = [[XPFBallLoadingView alloc] initWithFrame:view.bounds];
...
- (void)setupUI {
    ...
    self.greenBall.backgroundColor = [UIColor grayColor];
