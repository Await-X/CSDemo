...
@implementation XPFTopHeadImgView
...
- (HXPhotoManager *)manager {
    if (!_manager) {
        ...
        _manager.configuration.maxNum = SelectPhotoMaxNum;
...
- (void)photoView:(HXPhotoView *)photoView changeComplete:(NSArray<HXPhotoModel *> *)allList photos:(NSArray<HXPhotoModel *> *)photos videos:(NSArray<HXPhotoModel *> *)videos original:(BOOL)isOriginal {
    ...
    [self didNavOneBtnClickBlock:^(BOOL iscompletion) {
        ...
        {
            //
            if (self.delegateImg && [self.delegateImg respondsToSelector:@selector(onTopHeadImgAryS:)]) {
                //[self.delegateImgVideo onTopHeadImgVideoAry:self.selectList];
                [self.delegateImg onTopHeadImgAryS:self.imageRequestIds];
            }
        }
    }];
}
...
- (void)photoView:(HXPhotoView *)photoView updateFrame:(CGRect)frame {
    ...
    //
    if (self.delegateImg && [self.delegateImg respondsToSelector:@selector(onTopHeadImgViewH:)]) {
        [self.delegateImg onTopHeadImgViewH:(CGRectGetMaxY(frame) + kPhotoViewMargin)];
    }
}
